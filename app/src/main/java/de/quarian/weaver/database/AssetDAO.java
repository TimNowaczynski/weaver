...
public interface AssetDAO {
     ...
     */
    @Query("SELECT asset_id, fk_event_id, end_of_lifetime_timestamp, content_locally_present, asset_name, asset_description, asset_type, asset, fallback_url  FROM asset " +
    ...
    @Query("SELECT asset_id, fk_event_id, end_of_lifetime_timestamp, content_locally_present, asset_name, asset_description, asset_type, asset, fallback_url  FROM asset " +
            ...
            "AND end_of_lifetime_timestamp IS 0 " +
            "ORDER BY asset_name ASC")
    List<Asset> readAllAssetsWithIndefiniteLifetime();
    ...
    @Query("DELETE FROM asset WHERE end_of_lifetime_timestamp <= :timestamp")
